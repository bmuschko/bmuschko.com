...
You can set up Maven repositories on JCenter to host your released artifacts. Listing 3 shows how to publish the JAR file produced by the project to the link:https://bintray.com/bmuschko/experimental[repository named "experimental"]. Credentials can be provided through environment variables or project properties.
